                ...
                @foreach ($employees as $employee)
                    <tr class="intro-x">
                        <td>
                            ...
                            <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">{{ $employee->email }}</div>
                        </td>
                        <td>
                            @foreach($employee->roles as $role)
                                <span class="px-2 py-1 rounded-full bg-theme-1 text-white text-xs mr-1">{{ $role->name }}</span>
                            @endforeach
                        </td>
